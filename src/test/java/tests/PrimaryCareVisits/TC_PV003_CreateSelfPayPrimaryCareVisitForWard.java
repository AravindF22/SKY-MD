...
public class TC_PV003_CreateSelfPayPrimaryCareVisitForWard extends BaseTest {
    ...
    public void testPrimaryCareVisitValidation() throws InterruptedException {
        ...
        Thread.sleep(5000);
        Assert.assertTrue(primaryCareVisitPage.clickPatientAsWard(), "Failed to click Patient As ward option");
        Assert.assertTrue(primaryCareVisitPage.clickNextButton(), "Failed to click Next button after selecting Patient As ward option");

        //addWard
        Assert.assertTrue(primaryCareVisitPage.clickAddWard(), "Failed to click Add Ward Button");
        Thread.sleep(500);
        Assert.assertTrue(primaryCareVisitPage.setFirstName(testDataForWard.getFname()), "Failed to set first name");
        Assert.assertTrue(primaryCareVisitPage.setLastName(testDataForWard.getLname()), "Failed to set last name");
        Assert.assertTrue(primaryCareVisitPage.setDOB(testDataForWard.getDobForMajorInMMDD()), "Failed to set DOB");
        Assert.assertTrue(primaryCareVisitPage.setHeightFeet(testDataForWard.getFeet()), "Failed to set height feet");
        Assert.assertTrue(primaryCareVisitPage.setHeightInches(testDataForWard.getInch()), "Failed to set height inches");
        Assert.assertTrue(primaryCareVisitPage.setWeight(testDataForWard.getWeight()), "Failed to set weight");
        Assert.assertTrue(primaryCareVisitPage.selectGender(testDataForWard.getGender()), "Failed to select gender");
        Assert.assertTrue(primaryCareVisitPage.clickSaveButton(), "Failed to click Save Ward Button");

        Thread.sleep(2000);
        Assert.assertTrue(primaryCareVisitPage.clickNextButton(), "Failed to click Next button after adding Ward");
        //Staying in Self pay
        ...
        softAssert.assertEquals(primaryCareVisitPage.getFirstName(), testDataForWard.getFname(),
                "First name is mismatching in demographics");
        softAssert.assertEquals(primaryCareVisitPage.getLastName(), testDataForWard.getLname(),
                "Last name is mismatching in demographics");
        softAssert.assertEquals(primaryCareVisitPage.getDOBInMMDD(), testDataForWard.getDobForMajorInMMDD(),
                "DOB is mismatching in demographics");
        Assert.assertTrue(primaryCareVisitPage.setAddressLineOne(testDataForWard.getStreetAddressOne()),
                "Failed to enter address line one in demographics");
        Assert.assertTrue(primaryCareVisitPage.setAddressLineTwo(testDataForWard.getStreetAddressTwo()),
                "Failed to enter address line two in demographics");
        softAssert.assertEquals(primaryCareVisitPage.getZipcode(), testDataForWard.getZipCode(),
                "Zipcode is mismatching in demographics");
        softAssert.assertEquals(primaryCareVisitPage.getFeet(), testDataForWard.getFeet(),
                "Height Feet is mismatching in demographics");
        softAssert.assertEquals(primaryCareVisitPage.getInch(), testDataForWard.getInch(),
                "Height Inches is mismatching in demographics");
        softAssert.assertEquals(primaryCareVisitPage.getWeight(), testDataForWard.getWeight(),
                "Weight is mismatching in demographics");
        softAssert.assertEquals(primaryCareVisitPage.getGender(),testDataForWard.getGender(),
        ...
        Assert.assertTrue(primaryCareVisitPage.addAllergy(testDataForWard.getAllergyOne(),
                testDataForWard.getAllergyReactionOne(),
                testDataForWard.getDrugAllergyCategory()), "Failed to add allergy");
        ...
        Assert.assertTrue(primaryCareVisitPage.addMedication(
                ...
                testDataForWard.getDosageOne(),
                testDataForWard.getMedicationFormOne(),
                testDataForWard.getMedicationFrequencyOne(),
                testDataForWard.getMedicationPerOne()), "Failed to add medication");
        Assert.assertTrue(primaryCareVisitPage.clickNextButton(), "Failed to move to next step after medication");
        if(testDataForWard.getGender().equalsIgnoreCase("Female")){
        ...
        Assert.assertTrue(primaryCareVisitPage.setOptionalDetails(testDataForWard.getAdditionalText()),
    ...
    public void logPrimaryCareVisitDetails() {
        ...
        String visitDetailsHtml =
                "<b>Account Holder Details:</b><br>" +
                        ...
                        "Zipcode: " + testDataForWard.getZipCode() + "<br><br>" +
                        ...
                        "Symptoms: Fatigue<br>" +
                        "Allergy: " + testDataForWard.getAllergyOne() + "<br>" +
                        "Allergy Reaction: " + testDataForWard.getAllergyReactionOne() + "<br>" +
                        "Allergy Category: " + testDataForWard.getDrugAllergyCategory() + "<br>" +
                        "<b>Medication Details:</b><br>" +
                        "Medication: " + testDataForWard.getMedicationOne() + "<br>" +
                        "Dosage: " + testDataForWard.getDosageOne() + "<br>" +
                        "Form: " + testDataForWard.getMedicationFormOne() + "<br>" +
                        "Frequency: " + testDataForWard.getMedicationFrequencyOne() + "<br>" +
                        "Per: " + testDataForWard.getMedicationPerOne() + "<br>" +
                        "<b>Other Information:</b><br>" +
                        additionMedicalConditions +
                        "Additional Details: " + testDataForWard.getAdditionalText();
