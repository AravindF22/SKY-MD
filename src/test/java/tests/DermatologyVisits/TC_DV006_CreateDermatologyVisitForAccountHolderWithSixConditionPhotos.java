...
public class TC_DV006_CreateDermatologyVisitForAccountHolderWithSixConditionPhotos extends BaseTest {
    ...
    public MyVisitsPage myVisitsPage;
    ...
    public void testVisitPhotos() throws InterruptedException {
        ...
        Thread.sleep(500);
        Assert.assertTrue(dermatologyVisitPage.uploadCloseUpPic3(convertToAbsoluteURL(ConfigReader.getProperty("conditionPhotoFivePath"))), "Failed to upload close up photo 3");
        Thread.sleep(500);
        Assert.assertTrue(dermatologyVisitPage.uploadFarAwayPic3(convertToAbsoluteURL(ConfigReader.getProperty("conditionPhotoSixPath"))), "Failed to upload far away photo 3");
    ...
    public void testVisitValidationInPatientPortal() {
        ...
        softAssert.assertEquals(myVisitsPage.getVisitPhotosCount(),6,"Photo count mismatch in visit summary");
        softAssert.assertAll();
    }
